...
const API_KEY = 'b02f429ade9560595dd3a3b7d1e71000';
...
const getLinkAviasales = (data) => {
    ...
    // const years = prompt('Вы летите один или с ребёнком? Если один нажмите отмена а если с ребёнком укажите сколько ему лет !');

    // if(years !== null) {
    //     link += years < 8 && years > 2? '1' : link.slice(0, -1) + '2';
    // }
